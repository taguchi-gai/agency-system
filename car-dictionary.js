...
const CAR_CLASS_PRICE = { "軽": 15000, "普通": 18000, "ワンボックス": 20000 };
const YANI_OPTION_PRICE = 5000;
...
const CAR_DICTIONARY = [
  ...
  { maker: "トヨタ", model: "シエンタ", keywords: ["シエンタ", "SIENTA"], carClass: "ワンボックス", note: "要確認：コンパクトミニバンの区分" },
  { maker: "トヨタ", model: "ウィッシュ", keywords: ["ウィッシュ", "WISH"], carClass: "ワンボックス", note: "要確認：コンパクトミニバンの区分" },
  ...
  { maker: "ホンダ", model: "フリード", keywords: ["フリード", "FREED"], carClass: "ワンボックス", note: "要確認：コンパクトミニバンの区分" },
