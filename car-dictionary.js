...
const CAR_DICTIONARY = [
  ...
  { maker: "日産", model: "NV200 バネット", keywords: ["NV200", "バネット", "VANETTE"], carClass: "ワンボックス", priority: 20, note: "商用バン（本部確定 2026-09-22：ワンボックス）" },
  ...
  { maker: "フォルクスワーゲン", model: "シャラン / トゥーラン", keywords: ["シャラン", "SHARAN", "トゥーラン", "TOURAN"], carClass: "ワンボックス", priority: 20, note: "輸入ミニバン（本部確定 2026-09-22：ワンボックス）" },
  ...
  { maker: "プジョー", model: "リフター", keywords: ["リフター", "RIFTER"], carClass: "ワンボックス", priority: 20, note: "輸入ミニバン（本部確定 2026-09-22：ワンボックス）" },
  ...
  { maker: "ルノー", model: "カングー", keywords: ["カングー", "KANGOO"], carClass: "ワンボックス", priority: 20, note: "輸入ミニバン（本部確定 2026-09-22：ワンボックス）" },
